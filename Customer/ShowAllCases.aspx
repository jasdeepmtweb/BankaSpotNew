<%@ Page Title="" Language="C#" MasterPageFile="~/Customer/Site.Master" AutoEventWireup="true" CodeBehind="ShowAllCases.aspx.cs" Inherits="BankaSpotNew.Customer.ShowAllCases" %>
                                    ...
                                    <asp:GridView ID="GridAllCases" runat="server" CssClass="table table-bordered mb-0" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Remarks" HeaderText=" Status Remarks" />
                                             ...
                                             <asp:BoundField DataField="ConnectorMobileNo" HeaderText="Mobile No." />
                                            <asp:BoundField DataField="LeadHandling" HeaderText="Lead Handling" />
                                            <asp:BoundField DataField="EmpMobileNo" HeaderText="Mobile No." />
                                            ...
                                            <%--<asp:BoundField DataField="ConnectorName" HeaderText="Connnector" />--%>
