<%@ Page Title="" Language="C#" MasterPageFile="~/SubConnector/Site.Master" AutoEventWireup="true" CodeBehind="ShowLeads.aspx.cs" Inherits="BankaSpotNew.SubConnector.ShowLeads" %>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-12 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mb-3">Leads List</h4>
