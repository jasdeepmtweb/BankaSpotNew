<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerLogin.aspx.cs" Inherits="BankaSpotNew.CustomerLogin" %>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4">
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                <p><a href="Index.aspx" class="text-muted ms-1">Home</a></p>
                                <p><a href="ForgetPasswordCustomer.aspx" class="text-muted ms-1 text-primary">Forgot your password?</a></p>
                                <p class="text-muted">Don't have an account? <a href="RegisterCustomer.aspx" class="text-primary fw-medium ms-1">Sign Up</a></p>
                            </div>
                        </div>
                    </div>
                </div>
