...
{
    public partial class ShowCaseCountFromFreelancer : System.Web.UI.Page
    {
        ...
        private void BindGrid()
        {
            ...
            var result = oDataAccess.QuerySPListDynamic<Freelancer_Add>("sp_getfreelancercasecount_formarketemp", parameters);
        ...
        protected void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            var result = oDataAccess.QueryDynamic<Freelancer_Add>("sp_getfreelancercasecountformarketemp_usingdate", parameters);
