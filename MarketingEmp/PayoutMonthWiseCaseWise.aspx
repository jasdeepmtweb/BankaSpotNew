<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingEmp/Site.Master" AutoEventWireup="true" CodeBehind="PayoutMonthWiseCaseWise.aspx.cs" Inherits="BankaSpotNew.MarketingEmp.PayoutMonthWiseCaseWise" %>
         ...
         <div class="container-fluid">
             <div class="row">
                 <div class="col-lg-12 mx-auto">
                     <div class="card">
                         <div class="card-body">
                             <h4 class="header-title mb-3">Payouts Case Wise Month Wise</h4>
