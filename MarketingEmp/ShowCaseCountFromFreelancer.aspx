<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingEmp/Site.Master" AutoEventWireup="true" CodeBehind="ShowCaseCountFromFreelancer.aspx.cs" Inherits="BankaSpotNew.MarketingEmp.ShowCaseCountFromFreelancer" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12 mx-auto mt-2">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-3">Freelancer Case Count</h4>
                                <div class="table-responsive">
                                    <asp:GridView ID="GridShowConnector" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Name" HeaderText="Freelancer Name" />

                                            <asp:BoundField DataField="MobileNo" HeaderText=" Mobile No." />
                                            <asp:BoundField DataField="totalCases" HeaderText=" Total Case" />
                                            <asp:TemplateField HeaderText="Active Case">
                                                <ItemTemplate>
                                                    <a href="ShowAllCases.aspx?frid=<%# Eval("Id") %>&typ=all"><%# Eval("activeCases") %></a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Disbursed Case">
                                                <ItemTemplate>
                                                    <a href="ShowAllCases.aspx?frid=<%# Eval("Id") %>&typ=dis"><%# Eval("disbursedCases") %></a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Rejected Case">
                                                <ItemTemplate>
                                                    <a href="ShowAllCases.aspx?frid=<%# Eval("Id") %>&typ=rej"><%# Eval("rejectedCases") %></a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
