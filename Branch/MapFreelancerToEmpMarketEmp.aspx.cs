...
{
    public partial class MapFreelancerToEmpMarketEmp : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("FreelancerListForMapping.aspx");
            }
            if (!IsPostBack)
            {
                GetAllData();
        ...
        private void GetAllData()
        {
            ...
            var res = oDataAccess.QuerySingleOrDefaultSPDynamic<Freelancer_Add>("sp_getfreelancerby_id", parameters);
            if (res != null)
            {
            ...
            if (Page.IsValid)
            {
                try
                {
                    ...
                    if (Request.QueryString["id"] != null)
                    {
                        ...
                        oDataAccess.ExecuteSPDynamic("sp_mapfreelancerto_empmarketemp", parameters);
                        ...
                        oDataAccess.ExecuteSPDynamic("sp_inser_freelancermaphistory", parameters);

                        ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Updated');window.location.href='FreelancerListForMapping.aspx';", true);
                    }
                }
                catch (Exception ex)
                {
