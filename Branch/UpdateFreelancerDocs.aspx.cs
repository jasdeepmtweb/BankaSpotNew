...
{
    public partial class UpdateFreelancerDocs : System.Web.UI.Page
    {
        ...
        private void GetFreelancerData()
        {
            ...
            if (Page.IsValid)
            {
                try
                {
                    if (Request.QueryString["id"] != null)
                    {
                        ...
                        ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Updated');window.location.href='ShowFreelancer.aspx';", true);
                    }
                }
                catch (Exception ex)
                {
