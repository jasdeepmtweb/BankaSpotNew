<%@ Page Title="" Language="C#" MasterPageFile="~/Branch/Site.Master" AutoEventWireup="true" CodeBehind="TransferCaseFromEmpToEmp.aspx.cs" Inherits="BankaSpotNew.Branch.TransferCaseFromEmpToEmp" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-3">Transfer Case</h4>
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Customer Name
                                    </label>
                                    <asp:Label ID="lblCustomerName" CssClass="form-control" runat="server"></asp:Label>
                                </div>
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Product Name
                                ...
                                <div class="mb-2">
                                    ...
                                    <asp:Label ID="lblPreviousEmp" CssClass="form-control" runat="server"></asp:Label>
                                </div>
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Employee Name
