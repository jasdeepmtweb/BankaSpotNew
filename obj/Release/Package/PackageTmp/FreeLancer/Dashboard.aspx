<%@ Page Title="" Language="C#" MasterPageFile="~/FreeLancer/Site.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="BankaSpotNew.FreeLancer.Dashboard" %>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="ShowDisbursedCases.aspx"><h5 class="text-muted fw-normal mt-0 text-truncate" title="Deals">Disbursed Cases</h5></a>
                                        <h3 class="my-2 py-1"><span data-plugin="counterup">
