<%@ Page Title="" Language="C#" MasterPageFile="~/FreeLancer/Site.Master" AutoEventWireup="true" CodeBehind="ShowPayouts.aspx.cs" Inherits="BankaSpotNew.FreeLancer.ShowPayouts" %>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="GridCase" runat="server" CssClass="table mb-0" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="PayDate" HeaderText=" Date" DataFormatString = "{0:dd/MM/yyyy}"/>
