<%@ Page Title="" Language="C#" MasterPageFile="~/MarketingEmp/Site.Master" AutoEventWireup="true" CodeBehind="AddCase.aspx.cs" Inherits="BankaSpotNew.MarketingEmp.AddCase" %>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                       Select Employee 
          <asp:RequiredFieldValidator ControlToValidate="ddlEmployee" InitialValue="0" ValidationGroup="a" ID="RequiredFieldValidator4" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </label>
                                    <asp:DropDownList ID="ddlEmployee" AutoPostBack="true" OnSelectedIndexChanged="ddlEmployee_SelectedIndexChanged" ValidationGroup="a" CssClass="form-control" runat="server"></asp:DropDownList>
                                </div>
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Product Required
                                ...
                                <div class="mb-2">
                                    ...
                                    <asp:TextBox ID="txtAddress" ValidationGroup="a" Text="-" TextMode="MultiLine" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Monthly Income
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    ...
                                    <asp:TextBox ID="txtBankName" ValidationGroup="a" CssClass="form-control" Text="-" runat="server"></asp:TextBox>
                                </div>
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Banker Name
                                    <%--<asp:RequiredFieldValidator ControlToValidate="txtBankEmpName" ValidationGroup="a" ID="RequiredFieldValidator6" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>--%>
                                    </label>
                                    <asp:TextBox ID="txtBankEmpName" ValidationGroup="a" CssClass="form-control" Text="-" runat="server"></asp:TextBox>
                                </div>
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Banker Mobile No.
                                    ...
                                    <asp:TextBox ID="txtBankEmpContact" ValidationGroup="a" Text="-" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Lead Handling
                                    <%--<asp:RequiredFieldValidator ControlToValidate="txtLeadHandling" ValidationGroup="a" ID="RequiredFieldValidator7" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>--%>
                                    </label>
                                ...
                                <div class="mb-2">
                                    ...
                                    <asp:TextBox ID="txtLeadGeneratedContactNo" ValidationGroup="a" MaxLength="10" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        File LogIn Date
