<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Site.Master" AutoEventWireup="true" CodeBehind="AddCase.aspx.cs" Inherits="BankaSpotNew.Employee.AddCase" %>
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                 ...
                                 <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                      Profile
                                        <asp:RequiredFieldValidator ControlToValidate="ddlProfile" InitialValue="0" ValidationGroup="a" ID="RequiredFieldValidator12" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </label>
                                    <%--<asp:TextBox ID="txtProfile" ValidationGroup="a" CssClass="form-control" runat="server"></asp:TextBox>--%>
                                     <asp:DropDownList runat="server" ID="ddlProfile" CssClass="form-control" ValidationGroup="a">
                                     </asp:DropDownList>
                                </div>
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
