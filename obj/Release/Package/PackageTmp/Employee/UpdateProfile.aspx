<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Site.Master" AutoEventWireup="true" CodeBehind="UpdateProfile.aspx.cs" Inherits="BankaSpotNew.Employee.UpdateProfile" %>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Designation
                                        <asp:RequiredFieldValidator ControlToValidate="txtDesignation" ValidationGroup="a" ID="RequiredFieldValidator10" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </label>
                                    <asp:TextBox ID="txtDesignation" Enabled="false" ValidationGroup="a" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Date Of Anniversary
          <asp:RequiredFieldValidator ControlToValidate="txtDateOfAnniversary" ValidationGroup="a" ID="RequiredFieldValidator16" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </label>
                                ...
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Date Of Birth
          <asp:RequiredFieldValidator ControlToValidate="txtDateOfBirth" ValidationGroup="a" ID="RequiredFieldValidator17" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </label>
