<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Site.Master" AutoEventWireup="true" CodeBehind="Dashboard.aspx.cs" Inherits="BankaSpotNew.Employee.Dashboard" %>
            ...
            <div class="container-fluid">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="ShowDisbursedCases.aspx">
                                            <h5 class="text-muted fw-normal mt-0 text-truncate">Disbursed Cases</h5>
                                        </a>
                                        <h3 class="my-2 py-1"><span data-plugin="counterup">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="AllCases.aspx">
                                            <h5 class="text-muted fw-normal mt-0 text-truncate">Pending Cases</h5>
                                        </a>
                                        <h3 class="my-2 py-1"><span data-plugin="counterup">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="ShowRejectedCases.aspx">
                                            <h5 class="text-muted fw-normal mt-0 text-truncate">Rejected Cases</h5>
                                        </a>
                                        <h3 class="my-2 py-1"><span data-plugin="counterup">
                ...
                <div class="row">
                                ...
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="GridCase" runat="server" CssClass="table table-striped table-nowrap table-centered mb-0" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Payout" HeaderText="Incentives" />
                                        </Columns>
                                    </asp:GridView>
                    ...
                    <div class="col-xl-6 mx-auto">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-3">Product Wise Target</h4>
                                <div class="table-responsive">

                                    <asp:GridView ID="GridConnector" runat="server" CssClass="table table-striped table-nowrap table-centered mb-0" AutoGenerateColumns="false">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Sr.No">
                                                <ItemTemplate>
                                                    <%#Container.DataItemIndex+1 %>
                                            ...
                                            <asp:BoundField DataField="ext1" HeaderText="Month" />
                                            <asp:BoundField DataField="ProductName" HeaderText="Product" />
                                            <asp:BoundField DataField="EmpTarget" HeaderText="Target" />
                                            ...
                                            <asp:BoundField DataField="IncentiveEarned" HeaderText="Incentive Earned" />
                                        </Columns>
                                    </asp:GridView>
