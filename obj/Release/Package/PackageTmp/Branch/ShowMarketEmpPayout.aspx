<%@ Page Title="" Language="C#" MasterPageFile="~/Branch/Site.Master" AutoEventWireup="true" CodeBehind="ShowMarketEmpPayout.aspx.cs" Inherits="BankaSpotNew.Branch.ShowMarketEmpPayout" %>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mb-3">Marketing Employee Payouts</h4>
                            <div class="table-responsive">
                                <asp:GridView ID="GridMarketEmpPayout" runat="server" CssClass="table table-bordered mb-0" AutoGenerateColumns="false">
                                    <Columns>
                                       ...
                                       <%-- <asp:BoundField DataField="PayDate" HeaderText=" Date Time" />
                                        <asp:BoundField DataField="PayAmount" HeaderText=" Payout" />
                                        --%>
                                        <asp:BoundField DataField="EmpName" HeaderText=" Employee" />
                                        <asp:BoundField DataField="CustomerName" HeaderText="File Name" />
