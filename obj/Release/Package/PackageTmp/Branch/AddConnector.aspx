<%@ Page Title="" Language="C#" MasterPageFile="~/Branch/Site.Master" AutoEventWireup="true" CodeBehind="AddConnector.aspx.cs" Inherits="BankaSpotNew.Branch.AddConnector" %>
                    ...
                    <div class="col-lg-6 mx-auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <asp:Label ID="lblConnectorIdNo" Visible="false" runat="server"></asp:Label>
                                <%--<div class="mb-2">
