<%@ Page Title="" Language="C#" MasterPageFile="~/Branch/Site.Master" AutoEventWireup="true" CodeBehind="CasesFromConnector.aspx.cs" Inherits="BankaSpotNew.Branch.CasesFromConnector" %>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="GridCaseFromConnector" runat="server" CssClass="table table-hover mb-0" AutoGenerateColumns="false">
                                        <Columns>
