<%@ Page Title="" Language="C#" MasterPageFile="~/Branch/Site.Master" AutoEventWireup="true" CodeBehind="FreelancerCaseCount.aspx.cs" Inherits="BankaSpotNew.Branch.FreelancerCaseCount" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-12 mx-auto mt-2">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-3">Active/Inactive Freelancers</h4>
                                    ...
                                    <asp:GridView ID="GridShowConnector" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Active Case">
                                                <ItemTemplate>
                                                    <a href="ShowCases.aspx?frid=<%# Eval("Id") %>"><%# Eval("activeCases") %></a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Disbursed Case">
                                                <ItemTemplate>
                                                    <a href="ShowDisbursedCases.aspx?frid=<%# Eval("Id") %>"><%# Eval("disbursedCases") %></a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Rejected Case">
                                                <ItemTemplate>
                                                    <a href="ShowRejectedCases.aspx?frid=<%# Eval("Id") %>"><%# Eval("rejectedCases") %></a>
                                                </ItemTemplate>
                                            </asp:TemplateField>
