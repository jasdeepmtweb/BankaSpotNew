<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="AddBanker.aspx.cs" Inherits="BankaSpotNew.Admin.AddBanker" %>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    <label for="exampleInputEmail1" class="form-label">
                                        Designation
    <asp:RequiredFieldValidator ControlToValidate="txtDesignation" ValidationGroup="a" ID="RequiredFieldValidator7" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </label>
