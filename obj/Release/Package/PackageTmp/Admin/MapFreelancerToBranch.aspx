<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="MapFreelancerToBranch.aspx.cs" Inherits="BankaSpotNew.Admin.MapFreelancerToBranch" %>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-6 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mb-3">Map Freelancer To Branch <b class="text-danger">(New Mapping Will Reset Employee ID And Marketing Employee ID)</b></h4>
                            <div class="mb-2">
