...
namespace BankaSpotNew.Employee
{
    public partial class EmployePerformanceReport : System.Web.UI.Page
    {
        ...
        protected void BtnSearch_Click(object sender, EventArgs e)
        {
            ...
            double SumTargetCompleted = EmpTargetList.Sum(p => p.TargetAchieved);

            lblTotalTarget.Text = SumTarget.ToString();
            lblTotalTargetAchieved.Text = SumTargetCompleted.ToString();
            lblTotalShortfall.Text = EmpTargetList.Sum(x => x.ShortFall).ToString();
