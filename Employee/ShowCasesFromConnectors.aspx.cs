...
{
    public partial class ShowCasesFromConnectors : System.Web.UI.Page
    {
        ...
        private void BindGrid(int id)
        {
            ...
            var result = oDataAccess.QuerySPDynamic<Case_Add>("sp_getcasesfromcon_forEmp", parameters);
            if (result != null)
            {
        ...
        protected void BtnCaseStatus_Click(object sender, EventArgs e)
        {
            ...
            Response.Redirect($"EditCaseStatus.aspx?id={button.CommandArgument}&pgtyp=1&amt={lblAmountReq.Text}");
        }
        ...
        protected void BtnDelete_Click(object sender, EventArgs e)
        {
            ...
            ClientScript.RegisterStartupScript(this.GetType(), "myalert", "alert('Deleted');window.location.href='ShowCasesFromConnectors.aspx';", true);
        }
    }
}