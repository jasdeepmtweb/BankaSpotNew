<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Site.Master" AutoEventWireup="true" CodeBehind="AddConnector.aspx.cs" Inherits="BankaSpotNew.Employee.AddConnector" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-3">Add Connector</h4>


                                <div class="mb-2">
                                    <label for="exampleInputEmail1" class="form-label">
                                        Connector ID No.
                                        <asp:RequiredFieldValidator ControlToValidate="txtConnectorIdNo" ValidationGroup="a" ID="RequiredFieldValidator1" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </label>
                                    <asp:TextBox ID="txtConnectorIdNo" ValidationGroup="a" CssClass="form-control" runat="server"></asp:TextBox>
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Date Of Anniversary
        <asp:RequiredFieldValidator ControlToValidate="txtDateOfAnniversary" ValidationGroup="a" ID="RequiredFieldValidator14" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                    </label>
                    ...
                    <div class="col-lg-6 mx-auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <asp:Button ID="BtnSubmit" runat="server" Visible="false" ValidationGroup="a" OnClick="BtnSubmit_Click" CssClass="btn btn-primary" Text="Submit" />
                            </div>
                        </div>
                    </div>
                </div>
