<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Site.Master" AutoEventWireup="true" CodeBehind="EditCase.aspx.cs" Inherits="BankaSpotNew.Employee.EditCase" %>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6 mx-auto">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title mb-3">Edit Case</h4>
                                ...
                                <asp:Button ID="BtnSubmit" runat="server" Text="Submit" ValidationGroup="a" OnClick="BtnSubmit_Click" CssClass="btn btn-primary btn-sm" />
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 mx-auto">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Marketing Employee
         <%--<asp:RequiredFieldValidator ControlToValidate="txtMarketingEmployee" ValidationGroup="a" ID="RequiredFieldValidator1" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>--%>
                                    </label>
                                    <asp:Label ID="txtMarketingEmployee" CssClass="form-control" runat="server"></asp:Label>
                                </div>
                                <div class="mb-2">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Bank Name
