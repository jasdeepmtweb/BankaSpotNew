<%@ Page Title="" Language="C#" MasterPageFile="~/Employee/Site.Master" AutoEventWireup="true" CodeBehind="EditCaseStatus.aspx.cs" Inherits="BankaSpotNew.Employee.EditCaseStatus" %>
        ...
        <div class="content">
         ...
         <asp:RequiredFieldValidator ControlToValidate="txtProduct" ValidationGroup="a" ID="RequiredFieldValidator10" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                ...
                                <div class="mb-2">
                                    ...
                                    <asp:DropDownList ID="ddlStatus" ValidationGroup="a" CssClass="form-control" OnSelectedIndexChanged="ddlStatus_SelectedIndexChanged" AutoPostBack="true" runat="server"></asp:DropDownList>
                                </div>
         ...
         <asp:RequiredFieldValidator ControlToValidate="txtPreAmountDisbursed" ValidationGroup="a" ID="RequiredFieldValidator7" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                ...
                                <div class="mb-2" id="divRemainingAmount" runat="server" visible="false">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Remaining Amount 
                                ...
                                <div class="mb-2" id="divLoanAcc" runat="server" visible="false">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Loan Account Number
                                ...
                                <div class="mb-2" id="divDisbursedDate" runat="server" visible="false">
                                    <label for="exampleInputPassword1" class="form-label">
                                        Disbursed Date
          <asp:RequiredFieldValidator ControlToValidate="txtDisbursedDate" ValidationGroup="a" ID="RequiredFieldValidator5" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                ...
                                <div class="mb-2" id="divCaseBooked" runat="server" visible="false">
                                    <label for="exampleInputPassword1" class="form-label">
                                        File Booked In
          <asp:RequiredFieldValidator ControlToValidate="txtCaseBookedOn" ValidationGroup="a" ID="RequiredFieldValidator6" runat="server" ErrorMessage="*Required" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
                                ...
                                <%--  <div class="mb-2">
                                    ...
                                    <asp:FileUpload ID="fileSlip" accept=".jpg,.jpeg,.png" runat="server" class="form-control"></asp:FileUpload>
                                </div>--%>

                                <div class="mb-2" runat="server" id="divMessage" visible="false">
                                    <label class="form-label" style="color: red;">
                                        Please Confirm Exact Disbursed Amount And Loan Account No. From Banker. If Amount is Confirmed Please Proceed
                                    </label>
                                </div>

                                <asp:Button ID="BtnFirstSubmit" runat="server" ValidationGroup="a" OnClick="BtnFirstSubmit_Click" CssClass="btn btn-primary" Text="Submit" />
                                <asp:Button ID="BtnSubmit" runat="server" ValidationGroup="a" OnClick="BtnSubmit_Click" Visible="false" CssClass="btn btn-primary" Text="Final Submit" />
