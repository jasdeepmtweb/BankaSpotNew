...
{
    public partial class PayoutMonthWiseCaseWise : System.Web.UI.Page
    {
        ...
        private void BindGrid(int id)
        {
            ...
            var result = oDataAccess.QuerySPListDynamic<Payouts_Add>("sp_getpayoutsby_useridtype", parameters);
            if (result != null)
            {
