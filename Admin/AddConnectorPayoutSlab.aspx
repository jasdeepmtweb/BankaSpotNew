<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Site.Master" AutoEventWireup="true" CodeBehind="AddConnectorPayoutSlab.aspx.cs" Inherits="BankaSpotNew.Admin.AddConnectorPayoutSlab" %>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-3 mx-auto">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="header-title mb-3">Add Connector Payout Slab (<asp:Label ID="lblProductName" runat="server" Text="Label"></asp:Label>)</h4>
                            <div class="mb-2">
