<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConnectorLogin.aspx.cs" Inherits="BankaSpotNew.ConnectorLogin" %>
                    ...
                    <div class="col-md-8 col-lg-6 col-xl-4">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="mb-2">
                                 ...
                                 <div class="mb-3">
                                     ...
                                     <asp:CheckBox ID="CheckAgree" style="margin-left: -20px;" runat="server" />
                        ...
                        <div class="row mt-3">
                            <div class="col-12 text-center">
                                ...
                                <p class="text-muted">Back To Home <a href="AppIndex.aspx" class="text-primary fw-medium ms-1">Click Here</a></p>
                            </div>
                        </div>
                    </div>
                </div>
